...
duration_ar = np.array(df['duration'])
morning_time_ar = np.array(df['morning_time'])
noon_time_ar = np.array(df['noon_time'])
afternoon_time_ar = np.array(df['afternoon_time'])
evening_time_ar = np.array(df['evening_time'])
...
# Creating dataset
###converting columns to arrays
duration_ar = np.array(df['energy'])
morning_time_ar = np.array(df['morning_energy'])
noon_time_ar = np.array(df['noon_energy'])
afternoon_time_ar = np.array(df['afternoon_energy'])
evening_time_ar = np.array(df['evening_energy'])
...
# Creating dataset
###converting columns to arrays
duration_ar = np.array(df['distance'])
morning_time_ar = np.array(df['morning_distance'])
noon_time_ar = np.array(df['noon_distance'])
afternoon_time_ar = np.array(df['afternoon_distance'])
evening_time_ar = np.array(df['evening_distance'])
...
values = np.array(df['day_part'].value_counts())
